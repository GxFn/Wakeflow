# Scenario Pod Progress

## Unified Status

<!-- unified-status:start -->
Demand: SCENARIO-POD - Scenario Pod
Main state: intake
Stage: none
...
Exercise the Pod local lifecycle.

## Completion Definition

Pod local lifecycle is recorded.
...
- @wakeflow-scenario-time demand cancelled — scenario pod lifecycle close
