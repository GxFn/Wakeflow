...
/**
 * Append one delivery for a planned, rework-requested, product-defect-rework-requested, or rearm-exhausted target: take the window work claim, render the prompt skeleton, and return the one-shot permit.
 */
