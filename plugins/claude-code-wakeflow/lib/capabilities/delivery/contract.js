...
export const REARM_DELIVERY_TOOL_REGISTRATION = Object.freeze({
    ...
    description: "Rearm one delivery whose current generation is rejected-before-send: the same envelope and prompt get a fresh window work claim and fence, the generation increases by one, and the permit is re-issued. At most three rearms per envelope; after that prepare the target again with a new envelope. Never performs the host effect.",
