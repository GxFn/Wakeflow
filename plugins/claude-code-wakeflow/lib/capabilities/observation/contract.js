import { WAKEFLOW_STATUS_REQUEST_SCHEMA, } from "../../contracts/generated/entrypoints/wakeflow-status-request.generated.js";
import { WAKEFLOW_STATUS_RESULT_SCHEMA, } from "../../contracts/generated/entrypoints/wakeflow-status-result.generated.js";
import { WAKEFLOW_VERIFY_REQUEST_SCHEMA, } from "../../contracts/generated/entrypoints/wakeflow-verify-request.generated.js";
import { WAKEFLOW_VERIFY_RESULT_SCHEMA, } from "../../contracts/generated/entrypoints/wakeflow-verify-result.generated.js";
...
export const parseStatusRequest = requestParser(createRuntimeJsonSchemaValidator(WAKEFLOW_STATUS_REQUEST_SCHEMA));
export const admitStatusResult = resultAdmitter(createRuntimeJsonSchemaValidator(WAKEFLOW_STATUS_RESULT_SCHEMA));
export const parseVerifyRequest = requestParser(createRuntimeJsonSchemaValidator(WAKEFLOW_VERIFY_REQUEST_SCHEMA));
export const admitVerifyResult = resultAdmitter(createRuntimeJsonSchemaValidator(WAKEFLOW_VERIFY_RESULT_SCHEMA));
