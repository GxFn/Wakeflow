...
/**
 * Guidance for a checkout that is still present while the pod is closing; null otherwise. Wakeflow never removes worktrees itself.
 */
disposal: (null | {
/**
 * Suggested git worktree command for the Agent; it carries the checkout path relative to the workspace root (for a sibling worktree a ../ chain), never an absolute path.
 */
suggested: string
alternative: string
})
