...
export const PLANNING_RECORDED_AT = parseUtcInstant(
...
export async function createTargetTaskPlanningWorkspaceFixture(): Promise<
  Readonly<TargetTaskPlanningWorkspaceFixture>
> {
  ...
  const authorityRefs = published.loaded.documents.map((document) => (
  ...
  try {
    ...
    const created = await executeDemandEventSourcingCommand(repository, {
  ...
  return Object.freeze({
    ...
    request: Object.freeze({
      ...
      taskPackage: Object.freeze({
        ...
        acceptanceAnchors: Object.freeze([Object.freeze({
