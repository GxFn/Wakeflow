...
> 开发实施：[TypeScript 全新项目能力重构开发计划](../plan/typescript-reimplementation-plan.md#ts-dev-document-role)
...
[D9 source ownership](../archive/wakeflow-initialization-generated-files-requirement-2026-08-05.md#req-d09-source-ownership)确认的三层模型继续成立：共享语义只有一个 canonical source，宿主接缝拥有真实 Codex / Claude 差异，installed artifact 是只读运输物。
...
这与[全局基础服务候选](../archive/wakeflow-foundation-services-requirement-2026-08-11.md#foundation-candidate-register)的关系是：TS 可以表达已经确认的边界，但不自动证明某个重复 helper 应下沉。基础服务仍需独立完成 G1 语义交叉审查。
...
| --- | --- | --- |
| config、identity、layout | [D13](../archive/wakeflow-initialization-generated-files-requirement-2026-08-05.md#req-d13-config-v3)、[D14](../archive/wakeflow-initialization-generated-files-requirement-2026-08-05.md#req-d14-local-layout)、[D20](../archive/wakeflow-initialization-generated-files-requirement-2026-08-05.md#req-d20-local-stable-ids) | Schema/codegen + domain tests |
| active、demand、ledger | [D35-D37](../archive/wakeflow-initialization-generated-files-requirement-2026-08-05.md#req-d35-active-global)、[D5/D15](../archive/wakeflow-initialization-generated-files-requirement-2026-08-05.md#req-d05-ledger) | domain state/authority tests |
| transport、window runtime | [D17](../archive/wakeflow-initialization-generated-files-requirement-2026-08-05.md#req-d17-transport-retention)、[D21](../archive/wakeflow-initialization-generated-files-requirement-2026-08-05.md#req-d21-transport-contract)、[D22](../archive/wakeflow-initialization-generated-files-requirement-2026-08-05.md#req-d22-window-identity-runtime) | domain contract + host adapter |
| Pod 与宿主操作 | [D23](../archive/wakeflow-initialization-generated-files-requirement-2026-08-05.md#req-d23-claude-window-host)、[D24-D28](../archive/wakeflow-initialization-generated-files-requirement-2026-08-05.md#req-d24-pod-model)、[D29-D31](../archive/wakeflow-initialization-generated-files-requirement-2026-08-05.md#req-d29-keep-live)、[I3](../archive/wakeflow-initialization-generated-files-requirement-2026-08-05.md#req-i3-confirmed) | domain Pod + per-host contract |
| maintenance、observability | [D10](../archive/wakeflow-initialization-generated-files-requirement-2026-08-05.md#req-d10-reset-reconcile)、[D12](../archive/wakeflow-initialization-generated-files-requirement-2026-08-05.md#req-d12-observability)、[D34](../archive/wakeflow-initialization-generated-files-requirement-2026-08-05.md#req-d34-local-lifecycle) | domain transaction + minimal artifact integration |
| 全局 producer/consumer | [D38](../archive/wakeflow-initialization-generated-files-requirement-2026-08-05.md#req-d38-producer-consumer) | typed ports + owner tests + artifact smoke |
| migration 与 legacy 退役 | [D39/D40](../archive/wakeflow-initialization-generated-files-requirement-2026-08-05.md#req-d40-origin-fixtures)、[D19](../archive/wakeflow-initialization-generated-files-requirement-2026-08-05.md#req-d19-legacy-retirement) | bounded migration fixture gate |
| 开发与真实环境 | [D41](../archive/wakeflow-initialization-generated-files-requirement-2026-08-05.md#req-d41-dev-boundaries) | repository self-test + `WakeWorkspace` acceptance |
...
2. [基础服务需求](../archive/wakeflow-foundation-services-requirement-2026-08-11.md#foundation-admission)继续决定哪些能力应下沉、扩展、复用或保留在领域内。
...
独立开发实施文档见[TypeScript 全新项目能力重构开发计划](../plan/typescript-reimplementation-plan.md#ts-dev-document-role)。该文档负责真实代码核验、能力分区与层级、构建输入输出、覆盖矩阵、focused 命令、阶段门、失败恢复和 `WakeWorkspace` 验收；本文保持需求权威，不承担进度流水账。
