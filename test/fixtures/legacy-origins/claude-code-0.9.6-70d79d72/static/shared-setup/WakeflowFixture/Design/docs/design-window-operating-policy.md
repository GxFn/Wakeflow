...
- A design draft becomes executable only after its confirmed demand documents are promoted to `wakeflow-ledger/requirement-designs/<demand-key>/`, Wakeflow freezes those anchors as demand authority, and the controller creates task packages.
