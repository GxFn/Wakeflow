...
- This repository serves `ProductWindow`. Read this file, parent `../AGENTS.md`, `../WakeflowFixture/.wakeflow-active/index.md`, and `../WakeflowFixture/.wakeflow-active/current/workspace-current-status.md` first.
