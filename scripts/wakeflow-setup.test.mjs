...
test("sync-templates creates internal Design and Test surfaces when no external directories exist", () => {
  ...
  assert.equal(existsSync(path.join(fixture.parent, "Design/skills/requirements-framing/SKILL.md")), true);
  assert.equal(existsSync(path.join(fixture.parent, "Design/skills/design-interview-grill/SKILL.md")), true);
  assert.equal(existsSync(path.join(fixture.parent, "Design/skills/vertical-slice-requirement-planning/SKILL.md")), true);
  assert.equal(existsSync(path.join(fixture.parent, "Design/skills/heuristic-design-review/SKILL.md")), true);
  assert.equal(existsSync(path.join(fixture.parent, "Design/skills/accessibility-design-review/SKILL.md")), true);
  assert.equal(existsSync(path.join(fixture.parent, "Design/skills/handoff-quality-gate/SKILL.md")), true);
  assert.equal(existsSync(path.join(fixture.control, ".workspace-active/workspace/current/test-exchange.md")), true);
  assert.equal(existsSync(path.join(fixture.parent, "wakeflow-ledger/requirement-designs/README.md")), true);
  ...
  assert.equal(existsSync(path.join(fixture.parent, "Test/skills/risk-based-test-strategy/SKILL.md")), true);
  assert.equal(existsSync(path.join(fixture.parent, "Test/skills/diagnostic-feedback-loop/SKILL.md")), true);
  assert.equal(existsSync(path.join(fixture.parent, "Test/skills/behavior-first-regression-evidence/SKILL.md")), true);
  assert.equal(existsSync(path.join(fixture.parent, "Test/skills/e2e-playwright-practices/SKILL.md")), true);
  assert.equal(existsSync(path.join(fixture.parent, "Test/skills/accessibility-test-plan/SKILL.md")), true);
  assert.equal(existsSync(path.join(fixture.parent, "Test/skills/web-security-test-triage/SKILL.md")), true);
...
test("external Design and Test directories get only alignment templates", () => {
  ...
  assert.equal(existsSync(path.join(design, "skills/requirements-framing/SKILL.md")), true);
  assert.equal(existsSync(path.join(design, "skills/design-interview-grill/SKILL.md")), true);
  assert.equal(existsSync(path.join(design, "skills/vertical-slice-requirement-planning/SKILL.md")), true);
  ...
  assert.equal(existsSync(path.join(testWindow, "skills/risk-based-test-strategy/SKILL.md")), true);
  assert.equal(existsSync(path.join(testWindow, "skills/diagnostic-feedback-loop/SKILL.md")), true);
  assert.equal(existsSync(path.join(testWindow, "skills/behavior-first-regression-evidence/SKILL.md")), true);
  assert.equal(existsSync(path.join(testWindow, "skills/e2e-playwright-practices/SKILL.md")), true);
  assert.equal(existsSync(path.join(testWindow, "skills/accessibility-test-plan/SKILL.md")), true);
  assert.equal(existsSync(path.join(testWindow, "skills/web-security-test-triage/SKILL.md")), true);
