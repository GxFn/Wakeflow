...
export const LEDGER_AUTHORITY_RECORD_MAXIMUM_BYTES = parseByteCount(512 * 1024, "$ledger.recordMaximumBytes");
export const LEDGER_AUTHORITY_MEMBER_MAXIMUM_BYTES = parseByteCount(4 * 1024 * 1024, "$ledger.memberMaximumBytes");
export const LEDGER_AUTHORITY_TREE_MAXIMUM_BYTES = parseByteCount(16 * 1024 * 1024, "$ledger.treeMaximumBytes");
export const LEDGER_PUBLICATION_INTENT_MAXIMUM_BYTES = parseByteCount(1024 * 1024, "$ledger.publicationIntentMaximumBytes");
