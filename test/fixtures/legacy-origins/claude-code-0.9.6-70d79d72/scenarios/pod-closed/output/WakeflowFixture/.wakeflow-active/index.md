...
- [SCENARIO-POD](current/SCENARIO-POD/) — `cancelled`, revision 10, demand authority `frozen` (392f518fcbf3), placement `pod`, pod `SCENARIO-POD`, host `claude-code`, phase `execution-ready`, 4 logical window(s): 0 planned, 4 bound, 0 closed.
