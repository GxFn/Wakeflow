...
Entry points for the user: {{commandSurface}}
...
- Product repository and workspace `{{instructionFile}}` files bind you.
...
Perform the host effect exactly once: {{deliveryAction}} Then call
