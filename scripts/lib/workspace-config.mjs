...
export const defaultWorkspaceConfig = {
  ...
  repositories: [
    { windowName: "Design", path: "../workspace-ledger/design", role: "Internal requirement design workspace", managedAgents: false, mode: "internal" },
    { windowName: "Test", path: "../workspace-ledger/testing", role: "Internal test coordination workspace", managedAgents: false, mode: "internal" },
  ],
