 ...
 * Source: src/contracts/schemas/entrypoints/wakeflow-controller-test-review-decision-request.schema.json
 */

/**
 * Closed Controller-authored command for recording one Test TargetResult review decision against an inspected Snapshot baseline.
 */
export type WakeflowControllerTestReviewDecisionRequestV1 = ({
