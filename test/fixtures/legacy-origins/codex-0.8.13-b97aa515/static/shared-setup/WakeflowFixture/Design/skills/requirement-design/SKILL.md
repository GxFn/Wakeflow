...
This is a required output, not optional prose: a demand created without a recorded testing
decision surfaces a reminder at create-demand. "Run tests" is not a testing decision; name the
risk, the evidence, and the environment.
