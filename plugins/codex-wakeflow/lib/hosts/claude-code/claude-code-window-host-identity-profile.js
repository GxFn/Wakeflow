import { parseWakeflowWindowHostIdentityProfile, } from "../../workspace/window-runtime/wakeflow-window-host-identity-profile.js";
/** Claude Code session ID 的 opaque Window Host Identity 准入画像。 */
export const claudeCodeWindowHostIdentityProfile = parseWakeflowWindowHostIdentityProfile({
