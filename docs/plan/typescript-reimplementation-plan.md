...
| E3 能力覆盖与场景验收 | `in-progress` | 按 ADR-0008 从新旧对比改为能力覆盖与场景验收；场景验收骨架随每个纵切运行，2026-09-18 达 18 个场景全部 pass（[references/scenario-acceptance.md](../references/scenario-acceptance.md)）；能力映射矩阵 31 项旧工具无一"缺席"（重切或已落地 27、放弃 4）；旧实现只读保留，旧门已退出 `npm test` |
