...
} from "./claude-code-tmux-asset.js";
...
export const CLAUDE_CODE_TMUX_ASSET_OPERATION_KIND = "tmux-asset" as const;
export const CLAUDE_CODE_TMUX_ASSET_OWNER_ID = "claude-code-tmux-asset" as const;
export const CLAUDE_CODE_TMUX_ASSET_OPERATION_ID = "claude-tmux-asset:install" as const;
/** 资产读不出（目录、符号链接、超过 256 KiB、权限不足）时宿主贡献报出的 blocker。 */
export const CLAUDE_CODE_TMUX_ASSET_BLOCKER = "claude-tmux-asset-unreadable" as const;

const CLAUDE_CODE_TMUX_ASSET_DESCRIPTOR: Readonly<ClaudeCodeHostAssetDescriptor> =
  Object.freeze({
...
export function planClaudeCodeTmuxAssetOperation(
...
export function executeClaudeCodeTmuxAssetOperation(
  root: RootedDirectory,
