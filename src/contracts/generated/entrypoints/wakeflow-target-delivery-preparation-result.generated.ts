 ...
 * Source: src/contracts/schemas/entrypoints/wakeflow-target-delivery-preparation-result.schema.json
 */

/**
 * Successful preview or apply result for preparing one immutable implementation Target Delivery without claiming or performing a host effect.
 */
export type WakeflowTargetDeliveryPreparationResultV1 = (PreviewResult | ApplyResult)
...
purpose: ("initial" | "implementation-review-rework" | "product-defect-remediation")
targetTaskId: TargetTaskId
taskPackageId: TaskPackageId
taskPackageDigest: Sha256Digest
targetDeliveryId: TargetDeliveryId
