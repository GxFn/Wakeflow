...
function managedAllowEntries(existing) {
    const firstManagedIndex = existing.indexOf(WAKEFLOW_CLAUDE_CODE_MCP_PERMISSION_RULE);
 ...
 */
export function planClaudeCodePortableSettingsTransition(sourceTextValue) {
