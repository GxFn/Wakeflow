...
import { WAKEFLOW_CONFIG_AUTHORITY_LOCK_REF, } from "./wakeflow-config-authority-replacement-contract.js";
import { WAKEFLOW_CONFIG_FILE_REF, } from "./wakeflow-config-authority-snapshot.js";
/**
 * Wakeflow Configuration：Config 职责所有者的稳定资源目录。
 *
 * 资源目录只登记可以通过稳定逻辑路径寻址的 Config 权威记录和领域短锁。Config
 ...
 */
export const WAKEFLOW_CONFIG_AUTHORITY_RESOURCE_DECLARATION = parseWakeflowWorkspaceResourceDeclaration({
...
export const WAKEFLOW_CONFIG_AUTHORITY_LOCK_RESOURCE_DECLARATION = parseWakeflowWorkspaceResourceDeclaration({
    kind: "WakeflowWorkspaceResourceDeclaration",
