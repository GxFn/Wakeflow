...
| Non-bug outcome mismatch | revised requirement design or adjustment handoff | Redesign the solution before product redispatch. |
...
- Non-bug outcome mismatches explain why the next step is Design redesign, not
  another product-window point fix.
