import { WAKEFLOW_POD_REQUEST_SCHEMA, } from "../../contracts/generated/entrypoints/wakeflow-pod-request.generated.js";
import { WAKEFLOW_POD_RESULT_SCHEMA, } from "../../contracts/generated/entrypoints/wakeflow-pod-result.generated.js";
 ...
 */
export const WAKEFLOW_POD_PUBLIC_TOOL_NAME = "wakeflow_pod";
export const WAKEFLOW_POD_PUBLIC_SCHEMA_VERSION = 1;
const validateRequest = createRuntimeJsonSchemaValidator(WAKEFLOW_POD_REQUEST_SCHEMA);
const validateResult = createRuntimeJsonSchemaValidator(WAKEFLOW_POD_RESULT_SCHEMA);
