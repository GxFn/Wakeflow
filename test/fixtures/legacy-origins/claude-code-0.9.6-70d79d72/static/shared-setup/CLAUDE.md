...
- This is the `WakeflowFixture` total-control workspace on Claude Code. Total control owns cross-repository sequencing and final acceptance; it does not replace product-repository responsibility windows.
