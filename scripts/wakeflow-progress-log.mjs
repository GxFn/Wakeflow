...
function usageLines() {
  return [
    ...
    "",
    "Usage:",
    "  node scripts/wakeflow-progress-log.mjs --state-root <path> --type task-package --task-package-id <id> --summary <text> [--source-ref <ref>] [--write] [--json]",
    "  node scripts/wakeflow-progress-log.mjs --state-root <path> --type backfill --target-task-id <id> --target-window <window> [--evidence-ref <ref>] [--write] [--json]",
    "  node scripts/wakeflow-progress-log.mjs --state-root <path> --type decision --decision <text> [--event-id <id>] [--evidence-ref <ref>] [--write] [--json]",
    "",
    "Notes:",
...
function fail(message) {
  output({ ok: false, command: "wakeflow-progress-log", error: message });
  process.exitCode = 1;
