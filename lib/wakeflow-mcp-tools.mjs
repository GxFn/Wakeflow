...
export const tools = [
  ...
  },
  {
    ...
    description: "Record one target-window TargetResultEnvelope into a controller state root. This is target closeout evidence, not controller acceptance or next dispatch.",
