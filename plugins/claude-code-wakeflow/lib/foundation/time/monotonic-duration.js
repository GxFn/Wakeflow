...
export class MonotonicDurationError extends Error {
    name = "MonotonicDurationError";
    code = "wakeflow-monotonic-duration";
    reason;
    path;
...
function parseMoment(value, path) {
 ...
 */
export function monotonicDurationBetween(start, end) {
 ...
 */
export function monotonicDurationFromMilliseconds(milliseconds) {
