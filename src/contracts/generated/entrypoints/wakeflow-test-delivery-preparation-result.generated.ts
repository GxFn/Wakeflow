 ...
 * Source: src/contracts/schemas/entrypoints/wakeflow-test-delivery-preparation-result.schema.json
 */

/**
 * Successful preview or apply result for one immutable Test Delivery authorization; initial, rerun, and rejected-before-effect replacement remain owner-derived.
 */
export type WakeflowTestDeliveryPreparationResultV1 = (PreviewResult | ApplyResult)
...
kind: "WakeflowTestDeliveryPreparationApplyResult"
schemaVersion: 1
tool: "wakeflow_prepare_test_delivery"
mode: "apply"
status: "completed"
...
/**
 * Resulting state digest recorded by the preparation event; it remains stable when the same commit is replayed after later events.
 */
stateDigest: string
