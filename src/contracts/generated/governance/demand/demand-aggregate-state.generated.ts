...
export const WAKEFLOW_DEMAND_AGGREGATE_STATE_SCHEMA = restoreGeneratedSchema("{\"$schema\":\"https://json-schema.org/draft/2020-12/schema\",\"$id\":\"urn:wakeflow:governance:demand:aggregate-state:v1\",\"x-wakeflow-runtime-export\":\"WAKEFLOW_DEMAND_AGGREGATE_STATE_SCHEMA\",\"title\":\"WakeflowDemandAggregateState\",\"description\":\"由 Demand domain event reducer 唯一生成的最小业务 Aggregate state。\",\"$comment\":\"stream revision、event tail 与 snapshot metadata 不进入本状态；未实现的 Tasking、Delivery、Result、Testing、Review、Evidence 与 Pod 领域不会以空占位字段提前进入状态模型。\",\"type\":\"object\",\"additionalProperties\":false,\"required\":[\"artifactKind\",\"schemaVersion\",\"demandId\",\"lifecycle\"],\"properties\":{\"artifactKind\":{\"const\":\"wakeflow-demand-aggregate-state\"},\"schemaVersion\":{\"const\":1},\"demandId\":{\"$ref\":\"#/$defs/demandId\"},\"lifecycle\":{\"enum\":[\"active\",\"cancelled\"]}},\"$defs\":{\"demandId\":{\"type\":\"string\",\"pattern\":\"^demand_[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$\"}}}");
