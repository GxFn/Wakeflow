    ...
    inputSchema: {
      ...
      properties: {
        ...
        craftEvidence: {
          ...
          description: "Typed execution-craft evidence for the package's evidence contract: [{ kind, ref|value|commit, verify }]. Every entry needs at least one real proof payload; kind alone is rejected.",
        },
      },
    },
  },
