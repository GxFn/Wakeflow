import { WAKEFLOW_LOCAL_ROOT, } from "../../configuration/wakeflow-config.js";
 ...
 */
export const WAKEFLOW_LOCAL_ROOT_REF = parsePortableResourcePath(WAKEFLOW_LOCAL_ROOT);
export const WAKEFLOW_RUNTIME_ROOT_REF = parsePortableResourcePath(`${WAKEFLOW_LOCAL_ROOT}/runtime`);
export const WAKEFLOW_MAINTENANCE_ROOT_REF = parsePortableResourcePath(`${WAKEFLOW_RUNTIME_ROOT_REF}/maintenance`);
export const WAKEFLOW_MAINTENANCE_TRANSACTIONS_ROOT_REF = parsePortableResourcePath(`${WAKEFLOW_MAINTENANCE_ROOT_REF}/transactions`);
export const WAKEFLOW_MAINTENANCE_GATE_REF = parsePortableResourcePath(`${WAKEFLOW_RUNTIME_ROOT_REF}/maintenance.lock`);
function directoryDeclaration(declarationId, family, ownerId, relativePath) {
...
export const WAKEFLOW_LOCAL_ROOT_RESOURCE_DECLARATION = directoryDeclaration("local.root", "local-core", "maintenance-bootstrap", WAKEFLOW_LOCAL_ROOT_REF);
export const WAKEFLOW_RUNTIME_ROOT_RESOURCE_DECLARATION = directoryDeclaration("local.runtime-root", "local-core", "maintenance-bootstrap", WAKEFLOW_RUNTIME_ROOT_REF);
export const WAKEFLOW_MAINTENANCE_ROOT_RESOURCE_DECLARATION = directoryDeclaration("maintenance.root", "maintenance", "workspace-maintenance", WAKEFLOW_MAINTENANCE_ROOT_REF);
export const WAKEFLOW_MAINTENANCE_TRANSACTIONS_ROOT_RESOURCE_DECLARATION = directoryDeclaration("maintenance.transactions-root", "maintenance", "workspace-maintenance", WAKEFLOW_MAINTENANCE_TRANSACTIONS_ROOT_REF);
export const WAKEFLOW_MAINTENANCE_GATE_RESOURCE_DECLARATION = parseWakeflowWorkspaceResourceDeclaration({
    kind: "WakeflowWorkspaceResourceDeclaration",
