...
export type WakeflowErrorCode = (typeof WAKEFLOW_ERROR_CODES)[number];

const ERROR_CODE_SET: ReadonlySet<string> = new Set(WAKEFLOW_ERROR_CODES);

export function isWakeflowErrorCode(value: unknown): value is WakeflowErrorCode {
