...
- target inputs have been inspected and the relevant behavior independently validated;
...
Archive body files preserve result and validation snapshots. Summary maps live in `index.md`
