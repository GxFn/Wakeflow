...
/**
 * wakeflow_complete_demand 的结果：preview 给出 verify 报告、归档引用与阻塞项；apply 与 recover 返回终态事件回执、归档回执、需求包回执与释放的工作声明数（completion 恒为 0）。
 */
