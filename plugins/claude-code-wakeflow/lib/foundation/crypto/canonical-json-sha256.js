...
import { computeSha256Digest, } from "./sha256.js";
/**
...
export function computeCanonicalJsonSha256Digest(value, errorPath) {
    return computeSha256Digest(encodeCanonicalJson(value, errorPath), errorPath);
}
