...
- [SCENARIO-TRANSPORT](SCENARIO-TRANSPORT/developer-progress.md) — `planned`, revision 2, demand authority `draft-unfrozen` (confirmation pending), controller host `codex`, placement `main`.
