...
| Window | Status | Notes |
| --- | --- | --- |
| WakeflowFixture | idle | No active demand has been initialized; entry-sync windows should report ready and stop. |
| Design | standby | Use configured Design workspace; it delivers requirements to the global TODO board via wakeflow_deliver. |
